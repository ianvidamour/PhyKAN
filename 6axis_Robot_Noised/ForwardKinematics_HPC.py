...
torch.save(model, 'Noised Forward Kinematics Model 1L, N='+str(N)+' run '+str(run)+', noise_k='+str(noise_k)+'.pt')
np.save('Noised Training Accuracies 1L, , N='+str(N)+' run '+str(run)+', noise_k='+str(noise_k)+'.npy', accuracies)
