...
np.save('Noised MLP Accuracies 1L, N='+str(N)+' run ='+str(run)+', noise_k='+str(noise_k)+'.pt', accuracies)
torch.save(model, 'Noised Forward Kinematics MLP 1L, N='+str(N)+' run = '+str(run)+', noise_k='+str(noise_k)+'.pt')
